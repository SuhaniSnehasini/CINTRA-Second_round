      ...
      >
        <View style={styles.eventHeader}>
          ...
          <View style={styles.eventHeaderText}>
            <BadgeGroup style={{ marginBottom: 4 }}>
              <Badge text={String(action).toUpperCase()} variant={action} />
            </BadgeGroup>

            <Text style={styles.eventTimestamp} numberOfLines={1}>
        ...
        <View style={styles.blockchainBox}>
          ...
          <View style={styles.blockchainStatusRow}>
            ...
            <Badge text={String(blockchainStatus).toUpperCase()} variant={blockchainStatus} />
          </View>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryRow}>
              <View style={styles.summaryItem}>
                ...
                <Badge text={getEvidenceStatus()} variant={getEvidenceStatus()} />
              </View>
