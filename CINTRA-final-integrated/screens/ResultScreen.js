      ...
      {isMatch && response?.suspect && (
        <View style={styles.suspectCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <Badge
              text={response.suspect.wanted ? 'WANTED' : 'NOT WANTED'}
              variant={response.suspect.wanted ? 'CRITICAL' : 'NORMAL'}
            />
          </View>
          ...
          {response.suspect.alias && (
            <>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.value} numberOfLines={1}>{response.suspect.alias}</Text>
              </View>
            </>
          )}
          ...
          {response.suspect.fir_number && (
            <>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.value} numberOfLines={1}>{response.suspect.fir_number}</Text>
              </View>
            </>
          )}
          ...
          {response.suspect.offence_category && (
            <>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.value} numberOfLines={1}>{response.suspect.offence_category}</Text>
              </View>
            </>
          )}
          ...
          {response.suspect.applicable_section && (
            <>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.value} numberOfLines={1}>{response.suspect.applicable_section}</Text>
              </View>
            </>
          )}
          ...
          {response.suspect.severity && (
            <>
              ...
              <View style={styles.infoRow}>
                ...
                <Badge text={response.suspect.severity} variant={response.suspect.severity} />
              </View>
            </>
          )}
          ...
          {response.suspect.case_status && (
            <>
              ...
              <View style={styles.infoRow}>
                ...
                <Badge text={response.suspect.case_status} variant={response.suspect.case_status} />
              </View>
            </>
          )}
