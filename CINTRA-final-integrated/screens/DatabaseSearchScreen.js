      ...
      >
        <View style={styles.cardHeader}>
          ...
          <View style={styles.cardMainText}>
            <Text style={styles.recordTitle} numberOfLines={1}>{suspect.name}</Text>
            <Text style={styles.recordSubTitle} numberOfLines={1}>
              Subject ID: {suspectId} {suspect.alias ? `| Alias: "${suspect.alias}"` : ''}
            </Text>
          </View>

          <Badge type={suspect.wanted ? 'WANTED' : 'CLEARED'} label={suspect.wanted ? 'WANTED' : 'CLEARED'} />
        </View>

        <View style={styles.divider} />

        <View style={styles.metaWrapGrid}>
        ...
        <View style={styles.cardFooter}>
          <Text style={styles.viewDetailText} numberOfLines={1}>VIEW COMPLETE EVIDENCE RECORD & CUSTODY</Text>
      ...
      >
        <View style={styles.cardHeader}>
          ...
          <View style={styles.cardMainText}>
            ...
            <Text style={styles.recordSubTitle} numberOfLines={1}>
              ID: {evId} | Case: {ev.case_id || 'GENERAL-2024'}
            </Text>
          </View>

          <Badge type={ev.status || 'IN_CUSTODY'} />
        </View>
